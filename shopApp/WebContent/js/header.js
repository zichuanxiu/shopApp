...
function header(name){
	...
	str += "			<a title=\"www.fkjava.org\" href=\"http://www.fkjava.org\">www.fkjava.org</a>";
	str += "		</span>";
	str += "	</li>";
	str += "</ul>";
	str += "<ul class=\"fr lh\">";
	...
	str += "			<a href=\"javascript:window.external.addFavorite('http://www.fkjava.org','疯狂软件教育-购物商城');\">加入收藏</a>";
	str += "		</span>";
	str += "	</li>";
	str += "</ul>";
	str += "</div>";
	...
	str += "		<a href=\"index.action\" title=\"疯狂软件教育-购物商城\"><img alt=\"疯狂软件教育-购物商城\" src=\"images/logo.gif\"></a>";
	str += "	</h1>";
	str += "</div>";
	str += "<div class=\"banner\">";
	str += "	<a title=\"疯狂软件教育-购物商城\" href=\"javascript:void(0);\"></a>";
	str += "	<a title=\"疯狂软件教育-购物商城\" href=\"index.action\">";
	str += "	<em>";
	str += "	<img height=\"80\" width=\"552\" alt=\"疯狂软件教育-购物商城\" border=\"0\" src=\"images/banner.gif\">";
	str += "	</em></a>";
	str += "</div>";
	str += "<div class=\"rlink\">";
	str += "	<ul>";
